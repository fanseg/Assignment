...
public class CloseWeapon : MonoBehaviour
{
    ...
    public void Shoot()
    {
        ...
        RaycastHit hit;
        bool thereWasHit = Physics.Raycast(weaponBarrel.position, transform.forward, out hit, 5f);
        ...
        {
            lineRenderer.SetPosition(1, weaponBarrel.position + transform.forward * 5);
        }
    }
}
